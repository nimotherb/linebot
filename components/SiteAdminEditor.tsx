  ...
  return <main className="site-studio-shell">
    ...
    <div className="studio-layout">
      <aside className="studio-sidebar">
        ...
        <div className="studio-access"><small>ACCESS</small><b>店長／Admin</b><p>正式發布需由營運後台驗證權限。</p><a href="https://admin.equalspa.tw/" target="_blank" rel="noreferrer">開啟營運後台 ↗</a></div>
      </aside>
